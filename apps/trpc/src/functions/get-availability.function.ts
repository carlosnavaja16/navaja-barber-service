import getCalendarBusy from '../util/google-calendar.util.js';
import { calendar_v3 } from 'googleapis';
import { DateUtils } from '../util/date.util.js';
import { AvailabilityResponse, TimeSlot } from '@navaja/shared';
import { INCREMENT_MILLISECONDS } from '../constants.js';
