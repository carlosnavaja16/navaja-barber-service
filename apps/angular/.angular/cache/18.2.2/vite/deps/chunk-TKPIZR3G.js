...
import { __async, __superGet } from './chunk-5K356HEJ.js';
...
(function () {
  ...
  function n(f, a, c) {
    ...
    f.g[1] =
      (f.g[1] + (e + (((b2 << 21) & 4294967295) | (b2 >>> 11)))) & 4294967295;
  ...
  function y(f, a) {
    ...
    for (var c = v2(Math.pow(a, 8)), d = w, e = 0; e < f.length; e += 8) {
      var g = Math.min(8, f.length - e),
        b2 = parseInt(f.substring(e, e + g), a);
      8 > g
        ? ((g = v2(Math.pow(a, g))), (d = d.j(g).add(v2(b2))))
        : ((d = d.j(c)), (d = d.add(v2(b2))));
    }
    return d;
  }
  var w = u(0),
...
(function () {
  ...
  function xa() {
    ...
    let b2 = null;
    a.g &&
      ((b2 = a.g), (a.g = a.g.next), a.g || (a.h = null), (b2.next = null));
    return b2;
  }
  class Aa {
    constructor() {
  ...
  var Fa = (function () {
    ...
    var a = false,
      b2 = Object.defineProperty({}, 'passive', {
        get: function () {
          a = true;
        }
      });
  ...
  Ka.prototype.add = function (a, b2, c, d, e) {
    ...
    var g = La(a, b2, d, e);
    -1 < g
      ? ((b2 = a[g]), c || (b2.fa = false))
      : ((b2 = new Ia(b2, this.src, f, !!d, e)), (b2.fa = c), a.push(b2));
    return b2;
  };
  function Ma(a, b2) {
    var c = b2.type;
    if (c in a.g) {
      var d = a.g[c],
        e = Array.prototype.indexOf.call(d, b2, void 0),
        f;
  ...
  function Ta(a, b2, c, d, e, f) {
    ...
    if (a.addEventListener)
      Fa || (e = g),
        void 0 === e && (e = false),
        a.addEventListener(b2.toString(), d, e);
  ...
  function Ya(a, b2, c, d, e) {
    if (Array.isArray(b2))
      ...
      ((d = n(d) ? !!d.capture : !!d), (c = Sa(c)), a && a[D2])
        ? ((a = a.i),
          (b2 = String(b2).toString()),
          b2 in a.g &&
            ((f = a.g[b2]),
            (c = La(f, c, d, e)),
            -1 < c &&
              ...
              0 == f.length && (delete a.g[b2], a.h--))))
        : a &&
          (a = Ua(a)) &&
          ((b2 = a.g[b2.toString()]),
          (a = -1),
          b2 && (a = La(b2, c, d, e)),
          (c = -1 < a ? b2[a] : null) && Za(c));
  }
  function Za(a) {
    if ('number' !== typeof a && a && !a.da) {
      ...
      if (b2 && b2[D2]) Ma(b2.i, a);
        ...
        b2.removeEventListener
          ? b2.removeEventListener(c, d, a.capture)
          : b2.detachEvent
            ? b2.detachEvent(Wa(c), d)
            : b2.addListener && b2.removeListener && b2.removeListener(d);
        (c = Ua(b2))
          ? (Ma(c, a), 0 == c.h && ((c.src = null), (b2[Na] = null)))
          : Ja(a);
      }
    }
  }
  ...
  T.prototype.toString = function () {
    ...
    if (c || 'file' == b2)
      a.push('//'),
        (b2 = this.o) && a.push(vc(b2, wc, true), '@'),
        a.push(
  ...
  function tc(a, b2, c) {
    b2 instanceof sc
      ? ((a.i = b2), Ac(a.i, a.h))
      : (c || (b2 = vc(b2, Bc)), (a.i = new sc(b2, a.h)));
  }
  function S2(a, b2, c) {
    a.i.set(b2, c);
  }
  ...
  function Gc(a, b2) {
    ...
    fetch(a, {
      ...
      .then((f) => {
        clearTimeout(e);
        f.ok
          ? W2(c, 'TestPingServer: ok', true, b2)
          : W2(c, 'TestPingServer: server error', false, b2);
      })
      .catch(() => {
        clearTimeout(e);
  ...
  h.ea = function (a, b2, c, d) {
    ...
    !(0 <= Array.prototype.indexOf.call(Rc, b2, void 0)) ||
      d ||
      e ||
    ...
    if (this.s)
      if (((this.s = null), 1 == this.G)) {
        if (!a) {
          ...
          f &&
            (this.O
              ? (b2 = 'headers=' + encodeURIComponent(String(Oc(f))) + '&' + b2)
  ...
  function Ub(a, b2) {
    ...
    if (0 != a.G) {
      if (b2.o) {
        ...
        switch (
          (c && 0 < c.length && ((b2 = a.h), (b2.i = b2.i.concat(c))), e)
        ) {
          case 1:
            R(a, 5);
            break;
  ...
  function Y2(a, b2) {
    ...
    b2 &&
      b2.clientProtocolHeaderRequired &&
      (a
    ...
    b2 &&
      b2.va &&
      (a
        ? (a['X-WebChannel-Client-Profile'] = b2.va)
        : (a = {
    ...
    (b2 = b2 && b2.httpSessionIdParam) &&
      !t(b2) &&
      ((this.g.D = b2),
      (a = this.h),
      null !== a && b2 in a && ((a = this.h), b2 in a && delete a[b2]));
    this.j = new Z2(this);
  }
  r(Y2, E);
    ...
    const __PRIVATE_awaitNextToken = () => {
        ...
        e.enqueueRetryable(() =>
          __async(this, null, function* () {
            yield t2.promise,
              yield __PRIVATE_guardedChangeListener(this.currentUser);
          })
        );
      },
        ...
        ? this.auth.getToken(t).then((t2) =>
            ...
            this.i !== e
              ? (__PRIVATE_logDebug(
                ...
                this.getToken())
              : t2
                ? (__PRIVATE_hardAssert('string' == typeof t2.accessToken),
    ...
    return (
      ...
      this.appCheck
        ? this.appCheck
            ...
            .then((e2) =>
              e2
                ? (__PRIVATE_hardAssert('string' == typeof e2.token),
                  (this.R = e2.token),
...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
  ...
  constructor(e, t, n) {
    ...
    12.2 === ___PRIVATE_SimpleDb.S(getUA()) &&
      __PRIVATE_logError(
  ...
  static v() {
    ...
    return (
      ...
      'YES' ===
        (null === (e = process.__PRIVATE_env) || void 0 === e ? void 0 : e.C)
    );
  }
  ...
  M(e) {
    return __async(this, null, function* () {
      return (
          ...
          (this.db = yield new Promise((t, n) => {
            ...
            (r.onsuccess = (e2) => {
              ...
              (r.onupgradeneeded = (e2) => {
                ...
                this.p
                  .O(t2, r.transaction, e2.oldVersion, this.version)
                  .next(() => {
                    __PRIVATE_logDebug(
                      'SimpleDb',
        ...
        this.N && (this.db.onversionchange = (e2) => this.N(e2)),
        this.db
      );
    });
  }
...
var __PRIVATE_IndexedDbTransactionError = class extends FirestoreError {
  constructor(e, t) {
    super(v.UNAVAILABLE, `IndexedDB transaction '${e}' failed: ${t}`),
...
function __PRIVATE_checkForAndReportiOSError(e) {
  ...
  if (t >= 12.2 && t < 13) {
    ...
    if (e.message.indexOf(t2) >= 0) {
      ...
      return (
        M ||
          ((M = true), // Throw a global exception outside of this promise chain, for the user to
          // potentially catch.
          setTimeout(() => {
            throw e2;
          }, 0)),
...
var __PRIVATE_IndexBackfillerScheduler = class {
  ...
  X(e) {
    __PRIVATE_logDebug('IndexBackfiller', `Scheduled in ${e}ms`),
      (this.task = this.asyncQueue.enqueueAfterDelay('index_backfill', e, () =>
        __async(this, null, function* () {
          this.task = null;
          try {
            __PRIVATE_logDebug(
              'IndexBackfiller',
              `Documents written: ${yield this.Z.ee()}`
            );
          } catch (e2) {
          ...
          .next((t2) => {
            if (null !== t2 && !n.has(t2))
              return (
                __PRIVATE_logDebug(
                  'IndexBackfiller',
                  `Processing collection: ${t2}`
                ),
                this.ne(e, t2, r).next((e2) => {
                  (r -= e2), n.add(t2);
                })
              );
            i = false;
...
var __PRIVATE_ListenSequence = class {
  constructor(e, t) {
    (this.previousValue = e),
      t &&
        ((t.sequenceNumberHandler = (e2) => this.ie(e2)),
        (this.se = (e2) => t.writeSequenceNumber(e2)));
  }
  ie(e) {
    return (
  ...
  switch (n) {
    ...
    case 10:
      return (function __PRIVATE_compareVectors(e2, t2) {
        ...
        const o = e2.fields || {},
          _ = t2.fields || {},
          a = null === (n2 = o.value) || void 0 === n2 ? void 0 : n2.arrayValue,
          u = null === (r2 = _.value) || void 0 === r2 ? void 0 : r2.arrayValue,
...
var __PRIVATE_QueryImpl = class {
  ...
  constructor(
    ...
    (this.path = e),
      ...
      (this.startAt = o),
      (this.endAt = _),
      (this.ce = null), // The corresponding `Target` of this `Query` instance, for use with
  ...
  if (null === t.ce) {
    ...
    r.forEach((r2) => {
      e2.has(r2.canonicalString()) ||
        r2.isKeyField() ||
        t.ce.push(new OrderBy(r2, n));
    }), // Add the document key field to the last if it is not explicitly ordered.
      e2.has(FieldPath$1.keyField().canonicalString()) ||
        t.ce.push(new OrderBy(FieldPath$1.keyField(), n));
  }
  return t.ce;
}
function __PRIVATE_queryToTarget(e) {
  ...
  return (
    t.le ||
      (t.le = __PRIVATE__queryToTarget(t, __PRIVATE_queryNormalizedOrderBy(e))),
    t.le
  );
}
function __PRIVATE_queryToAggregateTarget(e) {
  const t = __PRIVATE_debugCast(e);
  return (
    t.he || // Do not include implicit order-bys for aggregate queries.
      (t.he = __PRIVATE__queryToTarget(t, e.explicitOrderBy)),
    t.he
  );
}
  ...
  return e instanceof __PRIVATE_ServerTimestampTransform
    ? (function serverTimestamp$1(e2, t2) {
        ...
        return (
          ...
          t2 && (n2.fields.__previous_value__ = t2),
          {
            mapValue: n2
          }
        );
      ...
      : e instanceof __PRIVATE_ArrayRemoveTransformOperation
        ...
        : (function __PRIVATE_applyNumericIncrementTransformOperationToLocalView(
            ...
            const n2 = __PRIVATE_computeTransformOperationBaseValue(e2, t2),
              r = asNumber(n2) + asNumber(e2.Pe);
            return isInteger(n2) && isInteger(e2.Pe)
    ...
    (function __PRIVATE_transformOperationEquals(e2, t2) {
      return (e2 instanceof __PRIVATE_ArrayUnionTransformOperation &&
        ...
        : e2 instanceof __PRIVATE_NumericIncrementTransformOperation &&
          ...
          ? __PRIVATE_valueEquals(e2.Pe, t2.Pe)
...
var BloomFilter = class _BloomFilter {
  ...
  Ee(e, t, n) {
    ...
    return (
      1 === r.compare(Te) && (r = new Integer([r.getBits(0), r.getBits(1)], 0)),
...
var __PRIVATE_WatchChangeAggregator = class {
  constructor(e) {
    (this.Le = e) /** The internal state of all tracked targets. */,
      ...
      (this.ke =
        __PRIVATE_mutableDocumentMap()) /** A mapping of document keys to their set of target IDs. */,
  ...
  We(e) {
    this.forEachTarget(e, (t) => {
      ...
      switch (e.state) {
        ...
        case 1:
          n.Oe(),
            n.Se || // We have a freshly added target, so we need to reset any state
    ...
    this.Be.forEach((n2, r2) => {
      ...
      if (i) {
        if (n2.current && __PRIVATE_targetIsDocumentTarget(i.target)) {
          ...
          null !== this.ke.get(t2) ||
            this.it(r2, t2) ||
            this.Ue(r2, t2, MutableDocument.newNoDocument(t2, e));
        }
  ...
  return 'found' in t
    ...
    : 'missing' in t
      ? (function __PRIVATE_fromMissing(e2, t2) {
          __PRIVATE_hardAssert(!!t2.missing),
            __PRIVATE_hardAssert(!!t2.readTime);
    ...
    const r = (function __PRIVATE_fromWatchTargetChangeState(e2) {
      ...
      s = (function __PRIVATE_fromBytes(e2, t2) {
        return e2.useProto3Json
          ? (__PRIVATE_hardAssert(void 0 === t2 || 'string' == typeof t2),
      ...
      ? t.updateTransforms.map((t2) =>
          (function __PRIVATE_fromFieldTransform(e2, t3) {
            ...
            if ('setToServerValue' in t3)
              __PRIVATE_hardAssert('REQUEST_TIME' === t3.setToServerValue),
...
function __PRIVATE_toRunAggregationQueryRequest(e, t, n, r) {
  const { _t: i, parent: s } = __PRIVATE_toQueryTarget(e, t),
    o = {},
    _ = [];
  let a = 0;
  return (
...
function __PRIVATE_fromDbMutationBatch(e, t) {
  const n = (t.baseMutations || []).map((t2) =>
    __PRIVATE_fromMutation(e.ct, t2)
  );
  ...
  const r = t.mutations.map((t2) => __PRIVATE_fromMutation(e.ct, t2)),
    ...
    (r =
      ...
      (function __PRIVATE_isDocumentQuery(e2) {
        ...
        ? (function __PRIVATE_fromDocumentsTarget(e2) {
            return (
              __PRIVATE_hardAssert(1 === e2.documents.length),
...
function __PRIVATE_toDbTarget(e, t) {
  ...
  i = __PRIVATE_targetIsDocumentTarget(t.target)
    ...
    : __PRIVATE_toQueryTarget(e.ct, t.target)._t;
  ...
  removeOverlaysForBatchId(e, t, n) {
    ...
    return (
      r.forEach((t2) => {
        ...
        i.push(
          __PRIVATE_documentOverlayStore(e).j('collectionPathOverlayIndex', r2)
        );
      }),
    ...
    const s = 'value',
      o =
        (null ===
          ...
          : r.length) || 0;
    this.dt(t, 15),
      t.At(__PRIVATE_normalizeNumber(o)), // Vectors then sort by position value
      this.Vt(s, t),
      this.Tt(i[s], t);
  }
  bt(e, t) {
...
function __PRIVATE_numberOfLeadingZerosInByte(e) {
  ...
  let t = 0;
  return (
    e >> 4 == 0 && // Test if the first four bits are zero.
      ((t += 4), (e <<= 4)),
    e >> 6 == 0 && // Test if the first two (or next two) bits are zero.
      ((t += 2), (e <<= 2)),
    e >> 7 == 0 && // Test if the remaining bit is zero.
      (t += 1),
    t
  );
}
...
var __PRIVATE_IndexByteEncoder = class {
  constructor() {
    (this.jt = new __PRIVATE_OrderedCodeWriter()),
      (this.Ht = new __PRIVATE_AscendingIndexByteEncoder(this.jt)),
...
var __PRIVATE_TargetIndexMatcher = class {
  ...
  rn(e) {
    if (
      (__PRIVATE_hardAssert(e.collectionGroup === this.collectionId), this.nn)
    )
      return false;
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  createTargetIndexes(e, t) {
    return PersistencePromise.forEach(this.hn(t), (t2) =>
      ...
      if (r) {
        ...
        return PersistencePromise.forEach(i, (i2, s) => {
          ...
          const o = (function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            l = this.In(i2, s, u),
            h = this.Tn(i2, s, _),
            P = this.En(i2.indexId, o, c, a.inclusive, l, u.inclusive, h);
          return PersistencePromise.forEach(P, (i3) =>
            n.G(i3, t.limit).next((t2) => {
              t2.forEach((t3) => {
  ...
  En(e, t, n, r, i, s, o) {
    const _ = (null != t ? t.length : 1) * Math.max(n.length, i.length),
      ...
      u = [];
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.dn(t[c / a]) : Re,
        l = this.An(e, _2, n[c % a], r),
        h = this.Rn(e, _2, i[c % a], s),
        P = o.map((t2) =>
          this.An(
            e,
            _2,
  ...
  dn(e) {
    ...
    return (
      __PRIVATE_FirestoreIndexValueWriter.vt.It(
        e,
        t.Yt(
          0
          /* IndexKind.ASCENDING */
  ...
  Tn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r)
        if (this.fn(t, s.fieldPath) && isArray(e2)) r = this.gn(r, s, e2);
        else {
  ...
  gn(e, t, n) {
    ...
    for (const e2 of n.arrayValue.values || [])
      for (const n2 of r) {
        ...
        r2.seed(n2.zt()),
          __PRIVATE_FirestoreIndexValueWriter.vt.It(e2, r2.Yt(t.kind)),
          i.push(r2);
      }
    return i;
  }
  ...
  createRange(e, t, n) {
    ...
    for (const i2 of n) {
      ...
      if (0 === n2) r[0] = e.Zt();
      else if (n2 > 0 && s < 0) r.push(i2), r.push(i2.Zt());
      else if (s > 0) break;
    }
    r.push(t);
    const i = [];
  ...
  getMinOffset(e, t) {
    return PersistencePromise.mapArray(this.hn(t), (t2) =>
      this.Pn(e, t2).next((e2) => e2 || fail())
...
var __PRIVATE_IndexedDbMutationQueue = class ___PRIVATE_IndexedDbMutationQueue {
    ...
    return s.add({}).next((o) => {
      ...
      const _ = new MutationBatch(o, t, n, r),
        a = (function __PRIVATE_toDbMutationBatch(e2, t2, n2) {
          const r2 = n2.baseMutations.map((t3) => toMutation(e2.ct, t3)),
            i2 = n2.mutations.map((t3) => toMutation(e2.ct, t3));
          return {
            userId: t2,
            batchId: n2.batchId,
  ...
  lookupMutationBatch(e, t) {
    return __PRIVATE_mutationsStore(e)
      ...
      .next((e2) =>
        e2
          ? (__PRIVATE_hardAssert(e2.userId === this.userId),
  ...
  Mn(e, t) {
    return this.Fn[t]
      ? PersistencePromise.resolve(this.Fn[t])
      ...
      .J(
        ...
        (e2, t2, r2) => {
          t2.userId === this.userId &&
            (__PRIVATE_hardAssert(t2.batchId >= n),
  ...
  removeMutationBatch(e, t) {
    return removeMutationBatch(e._e, this.userId, t).next(
      (n) => (
        e.addOnCommittedListener(() => {
          this.On(t.batchId);
        }),
...
var __PRIVATE_IndexedDbTargetCache = class {
  ...
  removeTargetData(e, t) {
    return this.removeMatchingKeysForTargetId(e, t.targetId)
      ...
      .next(
        (t2) => (
          __PRIVATE_hardAssert(t2.targetCount > 0),
          (t2.targetCount -= 1),
          this.Qn(e, t2)
        )
      );
  ...
  qn(e) {
    return __PRIVATE_globalTargetStore(e)
      .get('targetGlobalKey')
      .next((e2) => (__PRIVATE_hardAssert(null !== e2), e2));
  }
  Qn(e, t) {
...
var __PRIVATE_LruGarbageCollectorImpl = class {
  ...
  nthSequenceNumber(e, t) {
    ...
    return this.Jn.forEachTarget(e, (e2) => n.zn(e2.sequenceNumber))
      .next(() => this.Jn.Zn(e, (e2) => n.zn(e2)))
      .next(() => n.maxValue);
  }
  removeTargets(e, t, n) {
  ...
  Xn(e, t) {
    ...
    return this.calculateTargetCount(e, this.params.percentileToCollect)
      ...
      .next(
        (t2) => ((i = t2), (a = Date.now()), this.removeOrphanedDocuments(e, n))
      )
      .next((e2) => {
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
  ...
  getMetadata(e) {
    return __PRIVATE_documentGlobalStore(e)
      ...
      .next((e2) => (__PRIVATE_hardAssert(!!e2), e2));
  }
  rr(e, t) {
  ...
  applyChanges(e) {
    ...
    return (
      this.changes.forEach((i, s) => {
        ...
        if (
          (t.push(this.cr.removeEntry(e, i, o.readTime)), s.isValidDocument())
        ) {
...
var __PRIVATE_MemoryBundleCache = class {
  constructor(e) {
    (this.serializer = e),
      (this.hr = /* @__PURE__ */ new Map()),
      (this.Pr = /* @__PURE__ */ new Map());
  }
  getBundleMetadata(e, t) {
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r) {
    ...
    for (const t2 of r)
      (this.br = this.br.add(new __PRIVATE_DocReference(t2.key, i))),
  ...
  removeMutationBatch(e, t) {
    __PRIVATE_hardAssert(0 === this.Fr(t.batchId, 'removed')),
...
var __PRIVATE_MemoryPersistence = class {
  ...
  constructor(e, t) {
    ...
    (this.indexManager = new __PRIVATE_MemoryIndexManager()),
      (this.remoteDocumentCache =
        ...
        })((e2) => this.referenceDelegate.Wr(e2))),
  ...
  runTransaction(e, t, n) {
    ...
    return (
      ...
      n(r)
        .next((e2) => this.referenceDelegate.jr(r).next(() => e2))
        .toPromise()
...
var __PRIVATE_MemoryLruDelegate = class ___PRIVATE_MemoryLruDelegate {
  ...
  Zn(e, t) {
    return PersistencePromise.forEach(this.ti, (n, r) =>
      this.nr(e, n, r).next((e2) => (e2 ? PersistencePromise.resolve() : t(r)))
    );
  }
  removeTargets(e, t, n) {
  ...
  markPotentiallyOrphaned(e, t) {
    return (
      this.ti.set(t, e.currentSequenceNumber), PersistencePromise.resolve()
    );
  }
  removeTarget(e, t) {
    const n = t.withSequenceNumber(e.currentSequenceNumber);
  ...
  addReference(e, t, n) {
    return (
      this.ti.set(n, e.currentSequenceNumber), PersistencePromise.resolve()
    );
  }
  removeReference(e, t, n) {
    return (
      ...
      n < 3 &&
        ...
        (0 !== n &&
          (!(function __PRIVATE_dropQueryCache(e2) {
            e2.deleteObjectStore('targetDocuments'),
              e2.deleteObjectStore('targets'),
              e2.deleteObjectStore('targetGlobal');
          })(e),
          __PRIVATE_createQueryCache(e)),
        (s = s.next(() =>
          /**
        ...
        (s = s
          .next(() =>
            (function __PRIVATE_createRemoteDocumentCache(e2) {
              ...
              t2.createIndex('documentKeyIndex', L),
                t2.createIndex('collectionGroupIndex', B);
            })(e)
          )
          .next(() => this._i(e, i))
  ...
  ni(e) {
    ...
    return t.U().next((t2) =>
      PersistencePromise.forEach(t2, (t3) => {
        ...
        return n.U('userMutationsIndex', r).next((n2) =>
      ...
      return (
        ...
        PersistencePromise.forEach(n2, (e3, n3) => {
          const s = new User(n3),
            ...
            a = __PRIVATE_IndexedDbMutationQueue.lt(
              s,
              this.serializer,
              _,
              i.referenceDelegate
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    if (
      ...
      (this.di = (e2) => Promise.resolve()),
      !___PRIVATE_IndexedDbPersistence.D())
    )
      throw new FirestoreError(
        v.UNIMPLEMENTED,
    ...
    (this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r)),
      ...
      (this.Ri = new __PRIVATE_SimpleDb(
        this.Ai,
        this.hi,
        new __PRIVATE_SchemaConverter(this.serializer)
      )),
      (this.$r = new __PRIVATE_IndexedDbGlobalsCache()),
      (this.Ur = new __PRIVATE_IndexedDbTargetCache(
      ...
      (this.Gr = new __PRIVATE_IndexedDbBundleCache()),
          ...
          .next(() => {
            if (this.isPrimary)
              return this.wi(e).next((e2) => {
                e2 ||
                  ((this.isPrimary = false),
                  this.ui.enqueueRetryable(() => this.di(false)));
              });
          })
          .next(() => this.Si(e))
          .next((t) =>
            this.isPrimary && !t
              ? this.bi(e).next(() => false)
              : !!t && this.Di(e).next(() => true)
          )
    )
      .catch((e) => {
  ...
  wi(e) {
    return __PRIVATE_primaryClientStore(e)
      .get('owner')
      .next((e2) => PersistencePromise.resolve(this.vi(e2)));
  }
  Ci(e) {
  ...
  Fi() {
    return __async(this, null, function* () {
      if (this.isPrimary && !this.Mi(this.Ei, 18e5)) {
        this.Ei = Date.now();
        const e = yield this.runTransaction(
          'maybeGarbageCollectMultiClientState',
          'readwrite-primary',
          (e2) => {
            const t = __PRIVATE_getStore(e2, 'clientMetadata');
            return t.U().next((e3) => {
              const n = this.xi(e3, 18e5),
   ...
   */
  pi() {
    this.Ti = this.ui.enqueueAfterDelay('client_metadata_refresh', 4e3, () =>
      this.mi()
        .then(() => this.Fi())
        .then(() => this.pi())
    );
  ...
  shutdown() {
    return __async(this, null, function* () {
      (this.Kr = false),
        ...
        this.Bi(),
        this.ki(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
        // has obtained the primary lease.
        yield this.Ri.runTransaction(
          'shutdown',
          'readwrite',
  ...
  xi(e, t) {
    return e.filter(
      (e2) => this.Mi(e2.updateTimeMs, t) && !this.Ni(e2.clientId)
    );
  }
  /**
  ...
  Qi() {
    return this.runTransaction('getActiveClients', 'readonly', (e) =>
      __PRIVATE_clientMetadataStore(e)
        .U()
        .next((e2) => this.xi(e2, 18e5).map((e3) => e3.clientId))
    );
  }
  get started() {
    return this.Kr;
    ...
    return this.Ri.runTransaction(
      ...
      (r2) => (
        (s = new __PRIVATE_IndexedDbTransaction(
          r2,
          this.Qr ? this.Qr.next() : __PRIVATE_ListenSequence.oe
        )),
        'readwrite-primary' === t
          ? this.wi(s)
              .next((e2) => !!e2 || this.Si(s))
              .next((t2) => {
                if (!t2)
                  throw (
                    (__PRIVATE_logError(
                    ...
                    (this.isPrimary = false),
                    this.ui.enqueueRetryable(() => this.di(false)),
                    new FirestoreError(v.FAILED_PRECONDITION, F))
                  );
                return n(s);
              })
              .next((e2) => this.Di(s).next(() => e2))
          : this.Ki(s).next(() => n(s))
      )
  ...
  Ki(e) {
    return __PRIVATE_primaryClientStore(e)
      ...
      .next((e2) => {
        if (
          null !== e2 &&
          this.Mi(e2.leaseTimestampMs, 5e3) &&
          !this.Ni(e2.ownerId) &&
          !this.vi(e2) &&
          !(
            this.li ||
  ...
  ki() {
    this.Pi &&
      (this.window.removeEventListener('pagehide', this.Pi), (this.Pi = null));
  }
  /**
      ...
      0 === r
        ...
        : (null !== t.limit &&
          ...
          this.indexManager.getDocumentsMatchingTarget(e, n).next((r2) => {
            ...
            return this.Ji.getDocuments(e, i).next((r3) =>
              this.indexManager.getMinOffset(e, n).next((n2) => {
                const s = this.ts(t, r3);
                return this.ns(t, s, i, n2.readTime)
                  ? this.Yi(
                      e,
                      __PRIVATE_queryWithLimit(
                        t,
...
function __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e) {
  ...
  return t.persistence.runTransaction(
    ...
    'readonly',
    (e2) => t.Ur.getLastRemoteSnapshotVersion(e2)
  );
}
  ...
  return n.persistence
    .runTransaction('Apply remote event', 'readwrite-primary', (e2) => {
      ...
      t.targetChanges.forEach((s2, _2) => {
        ...
        if (!a2) return;
        o.push(
          n.Ur.removeMatchingKeys(e2, s2.removedDocuments, _2).next(() =>
            n.Ur.addMatchingKeys(e2, s2.addedDocuments, _2)
          )
        );
      ...
      if (
        ...
        const t2 = n.Ur.getLastRemoteSnapshotVersion(e2).next((t3) =>
          n.Ur.setTargetsMetadata(e2, e2.currentSequenceNumber, r)
        );
        o.push(t2);
      }
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence
    .runTransaction('Allocate target', 'readwrite', (e2) => {
      let r;
      return n.Ur.getTargetData(e2, t).next((i) =>
        i
          ? // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            ((r = i), PersistencePromise.resolve(r))
          : n.Ur.allocateTargetId(e2).next(
              (i2) => (
                (r = new TargetData(
                  t,
                  i2,
                ...
                n.Ur.addTargetData(e2, r).next(() => r)
              )
            )
      );
    })
    .then((e2) => {
      ...
      return (
        (null === r || e2.snapshotVersion.compareTo(r.snapshotVersion) > 0) &&
          ((n.os = n.os.insert(e2.targetId, e2)), n._s.set(t, e2.targetId)),
        e2
      );
    });
}
function __PRIVATE_localStoreReleaseTarget(e, t, n) {
  return __async(this, null, function* () {
    ...
    try {
      n ||
        (yield r.persistence.runTransaction('Release target', s, (e2) =>
    ...
    (e2) =>
      (function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
        const r2 = __PRIVATE_debugCast(e3),
          i2 = r2._s.get(n2);
        return void 0 !== i2
          ? PersistencePromise.resolve(r2.os.get(i2))
          : r2.Ur.getTargetData(t2, n2);
      })(r, e2, __PRIVATE_queryToTarget(t))
        .next((t2) => {
          if (t2)
            return (
              (i = t2.lastLimboFreeSnapshotVersion),
              r.Ur.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
                s = e3;
              })
            );
        })
        .next(() =>
          r.ss.getDocumentsMatchingQuery(
            e2,
            t,
...
function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
  return __async(this, null, function* () {
    ...
    const _ = i.cs.newChangeBuffer({
      ...
      a = yield __PRIVATE_localStoreAllocateTarget(
        i,
    ...
    return i.persistence.runTransaction(
      ...
      (e2) =>
        __PRIVATE_populateDocumentChangeBuffer(e2, _, o)
          ...
          .next((t2) =>
            i.Ur.removeMatchingKeysForTargetId(e2, a.targetId)
              .next(() => i.Ur.addMatchingKeys(e2, s, a.targetId))
              .next(() =>
                i.localDocuments.getLocalViewOfDocuments(e2, t2.Ps, t2.Is)
              )
              .next(() => t2.Ps)
          )
    );
...
function __PRIVATE_localStoreSaveNamedQuery(_0, _1) {
  return __async(
    this,
    arguments,
    function* (e, t, n = __PRIVATE_documentKeySet()) {
      const r = yield __PRIVATE_localStoreAllocateTarget(
          e,
      ...
      return i.persistence.runTransaction(
        ...
        (e2) => {
          ...
          return (
            (i.os = i.os.insert(o.targetId, o)),
            i.Ur.updateTargetData(e2, o)
              .next(() => i.Ur.removeMatchingKeysForTargetId(e2, r.targetId))
              .next(() => i.Ur.addMatchingKeys(e2, n, r.targetId))
              .next(() => i.Gr.saveNamedQuery(e2, t))
          );
        }
      );
    }
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    ...
    (this.storage = this.window.localStorage),
      (this.currentUser = i),
      (this.Ds = createWebStorageClientStateKey(this.persistenceKey, this.ps)),
      (this.vs =
        /** Assembles the key for the current sequence number. */
        (function createWebStorageSequenceNumberKey(e2) {
          return `firestore_sequence_number_${e2}`;
        })(this.persistenceKey)),
      (this.Ss = this.Ss.insert(this.ps, new __PRIVATE_LocalClientState())),
      (this.Cs = new RegExp(`^firestore_clients_${s}_([^_]*)$`)),
      (this.Fs = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`)),
      (this.Ms = new RegExp(`^firestore_targets_${s}_(\\d+)$`)),
      (this.xs =
        /** Assembles the key for the online state of the primary tab. */
        (function createWebStorageOnlineStateKey(e2) {
          return `firestore_online_state_${e2}`;
        })(this.persistenceKey)),
      (this.Os = (function createBundleLoadedKey(e2) {
          ...
          if (this.started) {
            if (null !== t.key) {
              if (this.Cs.test(t.key)) {
                ...
                const e2 = (function __PRIVATE_fromWebStorageSequenceNumber(
                  e3
                ) {
                ...
                e2 !== __PRIVATE_ListenSequence.oe &&
...
function __PRIVATE_generateUniqueDebugId() {
  return (
    null === fe
      ? (fe = (function __PRIVATE_generateInitialUniqueDebugId() {
...
var __PRIVATE_WebChannelConnection = class
  extends /**
  ...
  }
{
  ...
  No(e, t, n, r) {
    ...
    return new Promise((s, o) => {
          ...
          try {
            switch (_.getLastErrorCode()) {
              ...
              case ErrorCode.TIMEOUT:
                __PRIVATE_logDebug(pe, `RPC '${e}' ${i} timed out`),
                  o(
                    new FirestoreError(v.DEADLINE_EXCEEDED, 'Request time out')
                  );
                break;
                  ...
                  if (t3 && t3.status && t3.message) {
                    const e3 =
                      (function __PRIVATE_mapCodeFromHttpResponseErrorStatus(
                        ...
                        return Object.values(v).indexOf(t4) >= 0
                          ? t4
                          : v.UNKNOWN;
                      })(t3.status);
      ...
      __PRIVATE_logDebug(pe, `RPC '${e}' ${i} sending request:`, r),
  ...
  Bo(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)),
      this.useFetchStreams && (_.xmlHttpFactory = new FetchXmlHttpFactory({})),
      this.Oo(_.initMessageHeaders, t, n), // Sending the custom headers we just added to request.initMessageHeaders
        ...
        Io: (t2) => {
          h
            ...
            : (l ||
                ...
                c.open(),
                (l = true)),
              __PRIVATE_logDebug(pe, `RPC '${e}' stream ${r} sending:`, t2),
              c.send(t2));
        },
        To: () => c.close()
      }),
    ...
    return (
      __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
        h ||
          (__PRIVATE_logDebug(pe, `RPC '${e}' stream ${r} transport opened.`),
          P.yo());
      }),
      __PRIVATE_unguardedEventListen(c, WebChannel.EventType.CLOSE, () => {
        h ||
          ((h = true),
          __PRIVATE_logDebug(pe, `RPC '${e}' stream ${r} transport closed`),
          P.So());
      }),
      __PRIVATE_unguardedEventListen(c, WebChannel.EventType.ERROR, (t2) => {
        h ||
          ...
          __PRIVATE_logWarn(
            pe,
            `RPC '${e}' stream ${r} transport errored:`,
            t2
          ),
          P.So(
            new FirestoreError(
        ...
        if (!h) {
          ...
          if (o2) {
            ...
            void 0 === n3 &&
              ...
              (h = true),
              P.So(new FirestoreError(n3, i3)),
              c.close();
          } else
            __PRIVATE_logDebug(pe, `RPC '${e}' stream ${r} received:`, i2),
              P.bo(i2);
        }
      }),
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r = 1.5, i = 6e4) {
    (this.ui = e),
      ...
      (this.Qo = i),
      (this.Ko = 0),
      (this.$o = null) /** The last backoff attempt, as epoch milliseconds. */,
      (this.Uo = Date.now()),
      this.reset();
  }
  /**
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r, i, s, o, _) {
    (this.ui = e),
       ...
       */,
      (this.e_ = 0),
      (this.t_ = new __PRIVATE_ExponentialBackoff(e, t));
  }
  /**
  ...
  close(e, t) {
    return __async(this, null, function* () {
      this.u_(),
        this.c_(),
        this.t_.cancel(), // Invalidates any stream-related callbacks (e.g. from auth or the
        ...
        null !== this.stream &&
          (this.l_(), this.stream.close(), (this.stream = null)), // This state must be assigned before calling onClose() to allow the callback to
  ...
  Mo(e, t, n, r) {
    return (
      ...
      Promise.all([
        ...
        .then(([i, s]) =>
          this.connection.Mo(e, __PRIVATE_toResourcePath(t, n), r, i, s)
        )
        .catch((e2) => {
          throw 'FirebaseError' === e2.name
            ? (e2.code === v.UNAUTHENTICATED &&
                (this.authCredentials.invalidateToken(),
                this.appCheckCredentials.invalidateToken()),
              e2)
            : new FirestoreError(v.UNKNOWN, e2.toString());
        })
    );
  }
  ...
  Lo(e, t, n, r, i) {
    return (
      ...
      Promise.all([
        ...
        .then(([s, o]) =>
          this.connection.Lo(e, __PRIVATE_toResourcePath(t, n), r, s, o, i)
        )
        .catch((e2) => {
          throw 'FirebaseError' === e2.name
            ? (e2.code === v.UNAUTHENTICATED &&
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
    this.D_
      ? (__PRIVATE_logError(t), (this.D_ = false))
        ...
        n.enqueueAndForget(() =>
          __async(this, null, function* () {
            __PRIVATE_canUseNetwork(this) &&
              ...
              yield (function __PRIVATE_restartNetwork(e3) {
                return __async(this, null, function* () {
                  ...
                  t2.L_.add(
                    ...
                    yield __PRIVATE_disableNetworkInternal(t2),
                    t2.q_.set(
                      'Unknown'
                      /* OnlineState.Unknown */
                    ),
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.N_.delete(t),
    r.r_() && __PRIVATE_sendUnwatchRequest(n, t),
    0 === n.N_.size &&
      (r.r_()
        ? r.o_()
...
function __PRIVATE_shouldStartWatchStream(e) {
  return (
    ...
    !__PRIVATE_ensureWatchStream(e).n_() &&
    e.N_.size > 0
  );
}
  ...
  return __async(this, null, function* () {
    __PRIVATE_cleanUpWatchStreamState(e), // If we still need the watch stream, retry the connection.
      __PRIVATE_shouldStartWatchStream(e)
        ? (e.q_.M_(t), __PRIVATE_startWatchStream(e))
...
function __PRIVATE_onWatchStreamChange(e, t, n) {
  return __async(this, null, function* () {
    if (
      ...
      try {
        yield /** Handles an error on a target */
        (function __PRIVATE_handleTargetError(e2, t2) {
          return __async(this, null, function* () {
            const n2 = t2.cause;
            for (const r of t2.targetIds)
              e2.N_.has(r) &&
                (yield e2.remoteSyncer.rejectListen(r, n2),
                e2.N_.delete(r),
                e2.Q_.removeTarget(r));
          });
        })(e, t);
      } catch (n2) {
        __PRIVATE_logDebug(
          ...
          yield __PRIVATE_disableNetworkUntilRecovery(e, n2);
      }
    else if (
      ...
      try {
        const t2 = yield __PRIVATE_localStoreGetLastRemoteSnapshotVersion(
          e.localStore
        );
        ...
        __PRIVATE_logDebug('RemoteStore', 'Failed to raise snapshot:', t2),
          yield __PRIVATE_disableNetworkUntilRecovery(e, t2);
      }
  });
}
function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  return __async(this, null, function* () {
    ...
    e.L_.add(
      ...
      yield __PRIVATE_disableNetworkInternal(e),
      e.q_.set(
        'Offline'
        /* OnlineState.Offline */
      ),
...
function __PRIVATE_fillWritePipeline(e) {
  return __async(this, null, function* () {
    ...
    for (; __PRIVATE_canAddToWritePipeline(t); )
      try {
        const e2 = yield __PRIVATE_localStoreGetNextMutationBatch(
          t.localStore,
          r
        );
        if (null === e2) {
...
function __PRIVATE_shouldStartWriteStream(e) {
  return (
    __PRIVATE_canUseNetwork(e) &&
    !__PRIVATE_ensureWriteStream(e).n_() &&
    e.O_.length > 0
  );
}
...
function __PRIVATE_onMutationResult(e, t, n) {
  return __async(this, null, function* () {
    ...
    yield __PRIVATE_executeWithRecovery(e, () =>
...
function __PRIVATE_onWriteStreamClose(e, t) {
  return __async(this, null, function* () {
    t &&
      __PRIVATE_ensureWriteStream(e).V_ && // This error affects the actual write.
      (yield (function __PRIVATE_handleWriteError(e2, t2) {
        return __async(this, null, function* () {
          if (
            ...
            const n = e2.O_.shift();
            __PRIVATE_ensureWriteStream(e2).s_(),
              yield __PRIVATE_executeWithRecovery(e2, () =>
...
function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    n.L_.add(
      ...
      yield __PRIVATE_disableNetworkInternal(n),
...
function __PRIVATE_ensureWatchStream(e) {
  return (
    e.K_ || // Create stream (but note that it is not started yet).
...
function __PRIVATE_ensureWriteStream(e) {
  return (
    e.U_ || // Create stream (but note that it is not started yet).
      ...
      e.B_.push((t) =>
        __async(this, null, function* () {
          t
            ? (e.U_.s_(), // This will start the write stream if necessary.
              yield __PRIVATE_fillWritePipeline(e))
            : (yield e.U_.stop(),
              e.O_.length > 0 &&
                (__PRIVATE_logDebug(
...
function __PRIVATE_eventManagerListen(e, t) {
  return __async(this, null, function* () {
    ...
    s
      ? !s.H_() &&
        t.J_() && // Query has been listening to local cache, and tries to add a new listener sourced from watch.
        (r = 2)
      : ((s = new __PRIVATE_QueryListenersInfo()), (r = t.J_() ? 0 : 1));
    try {
      switch (r) {
        case 0:
    ...
    if (
      (n.queries.set(i, s),
      s.j_.push(t), // Run global snapshot listeners if a consistent snapshot has been emitted.
      t.Z_(n.onlineState),
      s.z_)
    ) {
    ...
    if (s) {
      ...
      e2 >= 0 &&
        ...
        0 === s.j_.length
          ? (i = t.J_() ? 0 : 1)
          : !s.H_() &&
            t.J_() && // The removed listener is the last one that sourced from watch.
            (i = 2));
    }
    switch (i) {
      case 0:
...
var __PRIVATE_QueryListener = class {
  ...
  X_(e) {
    ...
    return (
      this.na
        ? this.ia(e) && (this.ta.next(e), (t = true))
        : this.sa(e, this.onlineState) && (this.oa(e), (t = true)),
      (this.ra = e),
      t
    );
  }
...
var __PRIVATE_BundleLoader = class {
  ...
  la(e) {
    ...
    if (e.aa.namedQuery) this.queries.push(e.aa.namedQuery);
      ...
      e.aa.document &&
        ((this.documents[this.documents.length - 1].document = e.aa.document),
        ++t);
  ...
  complete() {
    return __async(this, null, function* () {
      const e = yield __PRIVATE_localStoreApplyBundledDocuments(
          this.localStore,
      ...
      for (const e2 of this.queries)
        yield __PRIVATE_localStoreSaveNamedQuery(
          this.localStore,
          e2,
          t.get(e2.name)
        );
...
var __PRIVATE_View = class {
  constructor(e, t) {
    (this.query = e),
      ...
      (this.Aa = __PRIVATE_newQueryComparator(e)),
   ...
   */
  ma(e, t) {
    const n = t ? t.fa : new __PRIVATE_DocumentChangeSet(),
      r = t ? t.Ra : this.Ra;
        ...
        if (u && c) {
          u.data.isEqual(c.data)
            ...
            : this.ga(u, c) ||
              ...
              (P = true),
              ((_ && this.Aa(c, _) > 0) || (a && this.Aa(c, a) < 0)) && // This doc moved from inside the limit to outside the limit.
  ...
  applyChanges(e, t, n, r) {
    ...
    s.sort(
      (e2, t2) =>
        ...
        })(e2.type, t2.type) || this.Aa(e2.doc, t2.doc)
    ),
      this.pa(n),
      (r = null != r && r);
    const o = t && !r ? this.ya() : [],
      _ = 0 === this.da.size && this.current && !r ? 1 : 0,
      a = _ !== this.Ea;
  ...
  Sa(e) {
    return (
      !this.Ta.has(e) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
      !!this.Ra.has(e) &&
  ...
  pa(e) {
    e &&
      (e.addedDocuments.forEach((e2) => (this.Ta = this.Ta.add(e2))),
      e.modifiedDocuments.forEach((e2) => {}),
      e.removedDocuments.forEach((e2) => (this.Ta = this.Ta.delete(e2))),
...
function __PRIVATE_allocateTargetAndMaybeListen(e, t, n, r) {
  return __async(this, null, function* () {
    const i = yield __PRIVATE_localStoreAllocateTarget(
        e.localStore,
        __PRIVATE_queryToTarget(t)
      ),
      s = i.targetId,
    ...
    return (
      r &&
        (_ = yield __PRIVATE_initializeViewAndComputeSnapshot(
          e,
          t,
          s,
          'current' === o,
...
function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  return __async(this, null, function* () {
    e.Ka = (t2, n2, r2) =>
      (function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
        return __async(this, null, function* () {
          ...
          return (
            __PRIVATE_updateTrackedLimbos(e2, t3.targetId, _2.wa), _2.snapshot
          );
        });
      })(e, t2, n2, r2);
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      r.sharedClientState.addPendingMutation(e2.batchId),
        ...
        yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(
          r,
          e2.changes
        ),
        yield __PRIVATE_fillWritePipeline(r.remoteStore);
    } catch (e2) {
...
function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  return __async(this, null, function* () {
    const n = __PRIVATE_debugCast(e);
    try {
      const e2 = yield __PRIVATE_localStoreApplyRemoteEventToLocalCache(
        n.localStore,
        t
      );
        ...
        r && // Since this is a limbo resolution lookup, it's for a single document
          ...
          e3.addedDocuments.size > 0
            ...
            : e3.modifiedDocuments.size > 0
              ? __PRIVATE_hardAssert(r.va)
              : e3.removedDocuments.size > 0 &&
                (__PRIVATE_hardAssert(r.va), (r.va = false)));
      }),
    ...
    r.Fa.forEach((n2, r2) => {
      ...
      (function __PRIVATE_eventManagerOnOnlineStateChange(e3, t2) {
        ...
        n2.queries.forEach((e4, n3) => {
          for (const e5 of n3.j_) e5.Z_(t2) && (r2 = true);
        }),
          r2 && __PRIVATE_raiseSnapshotsInSyncEvent(n2);
      })(r.eventManager, t),
      e2.length && r.Ca.d_(e2),
      (r.onlineState = t),
...
function __PRIVATE_syncEngineRejectListen(e, t, n) {
  return __async(this, null, function* () {
    ...
    if (s) {
      ...
      e2 = e2.insert(
        s,
        MutableDocument.newNoDocument(s, SnapshotVersion.min())
      );
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      __PRIVATE_processUserCallback(
        ...
        yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2);
    } catch (e2) {
      yield __PRIVATE_ignoreIfPrimaryLeaseLoss(e2);
    }
  });
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      __PRIVATE_processUserCallback(r, t, n),
        ...
        yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(r, e2);
    } catch (n2) {
...
function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
  return __async(this, null, function* () {
    ...
    try {
      const e2 =
        yield (function __PRIVATE_localStoreGetHighestUnacknowledgedBatchId(
          e3
        ) {
          const t2 = __PRIVATE_debugCast(e3);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      ...
      __PRIVATE_logDebug('SyncEngine', 'Document no longer in limbo: ' + r.key),
...
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.xa.size > 0 && e.Oa.size < e.maxConcurrentLimboResolutions; ) {
    ...
    const n = new DocumentKey(ResourcePath.fromString(t)),
      r = e.qa.next();
    e.Na.set(r, new LimboResolution(n)),
...
function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  return __async(this, null, function* () {
    ...
    r.Fa.isEmpty() ||
      ...
      yield Promise.all(o),
      r.Ca.d_(i),
      yield (function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
        return __async(this, null, function* () {
          ...
          try {
            yield n2.persistence.runTransaction(
              ...
              (e3) =>
                PersistencePromise.forEach(t2, (t3) =>
                  PersistencePromise.forEach(t3.$i, (r2) =>
                    ...
                    PersistencePromise.forEach(t3.Ui, (r2) =>
            ...
            __PRIVATE_logDebug(
              'LocalStore',
              'Failed to update sequence numbers: ' + e3
            );
          }
          for (const e3 of t2) {
            const t3 = e3.targetId;
            if (!e3.fromCache) {
              const e4 = n2.os.get(t3),
  ...
  return __async(this, null, function* () {
    ...
    if (!n.currentUser.isEqual(t)) {
      ...
      (n.currentUser = t), // Fails tasks waiting for pending writes requested by previous user.
        ...
        yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2.hs);
    }
  });
}
...
function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  return __async(this, null, function* () {
    const n = __PRIVATE_debugCast(e),
      r = yield __PRIVATE_localStoreExecuteQuery(
        n.localStore,
        t.query,
        /* usePreviousResults= */
        true
      ...
      i = t.view.ba(r);
    return (
      n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.wa), i
    );
  });
}
function __PRIVATE_syncEngineSynchronizeWithChangedDocuments(e, t) {
  return __async(this, null, function* () {
    const n = __PRIVATE_debugCast(e);
    return __PRIVATE_localStoreGetNewDocumentChanges(n.localStore, t).then(
      (e2) => __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2)
    );
  });
}
function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  return __async(this, null, function* () {
    const i = __PRIVATE_debugCast(e),
      s = yield (function __PRIVATE_localStoreLookupMutationDocuments(e2, t2) {
        const n2 = __PRIVATE_debugCast(e2),
          ...
          : 'acknowledged' === n || 'rejected' === n
            ? // NOTE: Both these methods are no-ops for batches that originated from
              ...
              (function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(
                ...
                __PRIVATE_debugCast(__PRIVATE_debugCast(e2).mutationQueue).On(
                  t2
                );
              })(i.localStore, t))
            : fail(),
  ...
  return __async(this, null, function* () {
    ...
    if (
      ...
      const e2 = n.sharedClientState.getAllActiveQueryTargets(),
        t2 = yield __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(
          n,
          e2.toArray()
        );
      (n.Qa = true),
        yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
      ...
      n.Ma.forEach((r, i) => {
        ...
        yield t2,
        yield __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(n, e2), // PORTING NOTE: Multi-Tab only.
        (function __PRIVATE_resetLimboDocuments(e3) {
          ...
          t3.Na.forEach((e4, n2) => {
            ...
            t3.La.pr(),
            (t3.Na = /* @__PURE__ */ new Map()),
            (t3.Oa = new SortedMap(DocumentKey.comparator));
        })(n),
        (n.Qa = false),
        yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
    }
  });
}
function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  return __async(this, null, function* () {
    ...
    for (const e2 of t) {
      ...
      if (n2 && 0 !== n2.length) {
        t2 = yield __PRIVATE_localStoreAllocateTarget(
          r.localStore,
          __PRIVATE_queryToTarget(n2[0])
        );
        for (const e3 of n2) {
          const t3 = r.Fa.get(e3),
            n3 = yield __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
          n3.snapshot && s.push(n3.snapshot);
        }
      } else {
        const n3 = yield __PRIVATE_localStoreGetCachedTarget(r.localStore, e2);
        (t2 = yield __PRIVATE_localStoreAllocateTarget(r.localStore, n3)),
  ...
  return __async(this, null, function* () {
    ...
    if (s && s.length > 0)
      switch (n) {
        case 'current':
        case 'not-current': {
          const e2 = yield __PRIVATE_localStoreGetNewDocumentChanges(
              i.localStore,
    ...
    if (r.Qa) {
      for (const e2 of t) {
        if (r.Ma.has(e2) && r.sharedClientState.isActiveQueryTarget(e2)) {
          __PRIVATE_logDebug(
            'SyncEngine',
            'Adding an already active target ' + e2
          );
          continue;
        }
        const t2 = yield __PRIVATE_localStoreGetCachedTarget(r.localStore, e2),
          n2 = yield __PRIVATE_localStoreAllocateTarget(r.localStore, t2);
        yield __PRIVATE_initializeViewAndComputeSnapshot(
          r,
...
function __PRIVATE_ensureWatchCallbacks(e) {
  ...
  return (
    ...
    (t.Ca.d_ = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager)),
    (t.Ca.$a = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager)),
    t
  );
}
  ...
  (function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    return __async(this, null, function* () {
      try {
        ...
        if (
          yield (function __PRIVATE_localStoreHasNewerBundle(e3, t3) {
            ...
            return n3.persistence
              .runTransaction('hasNewerBundle', 'readonly', (e4) =>
                n3.Gr.getBundleMetadata(e4, t3.id)
              )
        ...
        return (
          ...
          yield (function __PRIVATE_localStoreSaveBundle(e3, t3) {
            ...
            return n3.persistence.runTransaction(
              'Save bundle',
              'readwrite',
              (e4) => n3.Gr.saveBundleMetadata(e4, t3)
            );
          })(e2.localStore, r2),
        ...
        return (
          __PRIVATE_logWarn('SyncEngine', `Loading bundle failed with ${e3}`),
          n2._failWith(e3),
          Promise.resolve(/* @__PURE__ */ new Set())
        );
      }
  ...
  createPersistence(e) {
    const t =
      void 0 !== this.cacheSizeBytes
        ...
        : LruParams.DEFAULT;
    return new __PRIVATE_MemoryPersistence(
      (e2) => __PRIVATE_MemoryLruDelegate.Zr(e2, t),
      this.serializer
    );
  }
};
var __PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends MemoryOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(
        ___PRIVATE_IndexedDbOfflineComponentProvider.prototype,
        this,
        'initialize'
      ).call(this, e),
        yield this.Wa.initialize(this, e), // Enqueue writes from a previous session
        yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.Wa.syncEngine),
        yield __PRIVATE_fillWritePipeline(this.Wa.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
        // set it after localStore / remoteStore are started.
        yield this.persistence.yi(
          () => (
            this.gcScheduler &&
...
var __PRIVATE_MultiTabOfflineComponentProvider = class ___PRIVATE_MultiTabOfflineComponentProvider extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(
        ___PRIVATE_MultiTabOfflineComponentProvider.prototype,
        this,
        'initialize'
      ).call(this, e);
      ...
      this.sharedClientState instanceof __PRIVATE_WebStorageSharedClientState &&
        ...
        // set it after localStore / remoteStore are started.
        yield this.persistence.yi((e2) =>
          __async(this, null, function* () {
            yield __PRIVATE_syncEngineApplyPrimaryState(this.Wa.syncEngine, e2),
              this.gcScheduler &&
  ...
  initialize(e, t) {
    return __async(this, null, function* () {
      this.localStore ||
        ...
        yield __PRIVATE_remoteStoreApplyPrimaryState(
          this.remoteStore,
      ...
      yield (function __PRIVATE_remoteStoreShutdown(e2) {
        return __async(this, null, function* () {
          ...
          __PRIVATE_logDebug('RemoteStore', 'RemoteStore shutting down.'),
            ...
            yield __PRIVATE_disableNetworkInternal(t2),
            t2.k_.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    (this.ja = e),
      ...
      (this.Ha = (function __PRIVATE_newTextDecoder() {
        return new TextDecoder('utf-8');
      })()), // Read the metadata (which is the first element).
      this.Ja().then(
        (e2) => {
          e2 && e2.ua()
            ? this.metadata.resolve(e2.aa.metadata)
  ...
  Ya() {
    return __async(this, null, function* () {
      ...
      const e = this.eu();
      e < 0 &&
        this.Za('Reached the end of bundle when a length string is expected.');
  ...
  Xa(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.tu()) &&
          this.Za('Reached the end of bundle when more is expected.');
      }
      ...
      const t = yield (function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
        return __async(this, null, function* () {
          const n = __PRIVATE_debugCast(e2),
            ...
            s = /* @__PURE__ */ new Map();
          i.forEach((e3) => {
            const t3 = __PRIVATE_fromBatchGetDocumentsResponse(
              n.serializer,
              e3
            );
...
var __PRIVATE_TransactionRunner = class {
  ...
  ou(e) {
    this.nu > 0 && this._u(e)
      ? ((this.nu -= 1),
        this.asyncQueue.enqueueAndForget(() => (this.iu(), Promise.resolve())))
...
var FirestoreClient = class {
  constructor(e, t, n, r) {
    (this.authCredentials = e),
      ...
      this.authCredentials.start(n, (e2) =>
        __async(this, null, function* () {
          __PRIVATE_logDebug('FirestoreClient', 'Received user=', e2.uid),
            yield this.authCredentialListener(e2),
            (this.user = e2);
        })
      ),
          ...
          try {
            this._onlineComponents &&
              ...
              this._offlineComponents &&
                (yield this._offlineComponents.terminate()), // The credentials provider must be terminated after shutting down the
...
function __PRIVATE_setOfflineComponentProvider(e, t) {
  return __async(this, null, function* () {
    ...
    e.setCredentialChangeListener((e2) =>
      __async(this, null, function* () {
        r.isEqual(e2) ||
          (yield __PRIVATE_localStoreHandleUserChange(t.localStore, e2),
          (r = e2));
      })
...
function __PRIVATE_setOnlineComponentProvider(e, t) {
  return __async(this, null, function* () {
    ...
    __PRIVATE_logDebug(
      ...
      yield t.initialize(n, e.configuration), // The CredentialChangeListener of the online component provider takes
...
function __PRIVATE_canFallbackFromIndexedDbError(e) {
  return 'FirebaseError' === e.name
    ? e.code === v.FAILED_PRECONDITION || e.code === v.UNIMPLEMENTED
    : !('undefined' != typeof DOMException && e instanceof DOMException) || // When the browser is out of quota we could get either quota exceeded
        // or an aborted error depending on whether the error happened during
        // schema migration.
        22 === e.code ||
        20 === e.code || // Firefox Private Browsing mode disables IndexedDb and returns
      ...
      e._onlineComponents ||
        (e._uninitializedComponentsProvider
          ? (__PRIVATE_logDebug(
            ...
            yield __PRIVATE_setOnlineComponentProvider(
              e,
...
function __PRIVATE_getEventManager(e) {
  return __async(this, null, function* () {
    const t = yield __PRIVATE_ensureOnlineComponents(e),
      n = t.eventManager;
    return (
  ...
  return e.asyncQueue.enqueue(() =>
    __async(this, null, function* () {
      ...
      return (
        ...
        (function __PRIVATE_remoteStoreDisableNetwork(e2) {
          return __async(this, null, function* () {
            const t2 = __PRIVATE_debugCast(e2);
            t2.L_.add(
              0
    ...
    e.asyncQueue.enqueueAndForget(() =>
      __async(this, null, function* () {
        return (function __PRIVATE_readDocumentFromCache(e2, t2, n2) {
          return __async(this, null, function* () {
            try {
              const r = yield (function __PRIVATE_localStoreReadDocument(
                e3,
                t3
              ) {
                const n3 = __PRIVATE_debugCast(e3);
...
function __PRIVATE_firestoreClientGetDocumentViaSnapshotListener(e, t, n = {}) {
  ...
  return (
    e.asyncQueue.enqueueAndForget(() =>
      __async(this, null, function* () {
        return (function __PRIVATE_readDocumentViaSnapshotListener(
          e2,
          t2,
          n2,
          r2,
          ...
          const s = new __PRIVATE_AsyncObserver({
              next: (s2) => {
                ...
                !_ && s2.fromCache
                  ...
                  : _ && s2.fromCache && r2 && 'server' === r2.source
                    ? i.reject(
                        new FirestoreError(
                          v.UNAVAILABLE,
    ...
    e.asyncQueue.enqueueAndForget(() =>
      __async(this, null, function* () {
        try {
          ...
          r.resolve(
            (function __PRIVATE_invokeRunAggregationQueryRpc(e2, t2, n2) {
              return __async(this, null, function* () {
                var r2;
  ...
  enterRestrictedMode(e) {
    if (!this.cu) {
      ...
      t &&
        ...
        t.removeEventListener('visibilitychange', this.Eu);
    }
  }
  enqueue(e) {
          ...
          .catch((e2) => {
            ...
            const t2 =
              ...
              (function __PRIVATE_getMessageOrStack(e3) {
                let t3 = e3.message || '';
                e3.stack &&
                  (t3 = e3.stack.includes(e3.message)
                    ? e3.stack
                    : e3.message + '\n' + e3.stack);
                return t3;
              })(e2);
...
var Firestore = class extends Firestore$1 {
  ...
  _terminate() {
    return (
      this._firestoreClient || // The client must be initialized to ensure that all subsequent API
        // usage throws an exception.
        __PRIVATE_configureFirestore(this),
...
function enableMultiTabIndexedDbPersistence(e) {
  ...
  return __PRIVATE_setPersistenceProviders(
    t,
    r,
    new __PRIVATE_MultiTabOfflineComponentProvider(r, n.cacheSizeBytes)
  );
}
function __PRIVATE_setPersistenceProviders(e, t, n) {
  ...
  return e.asyncQueue
    .enqueue(() =>
      __async(this, null, function* () {
        try {
          yield __PRIVATE_setOfflineComponentProvider(e, n),
            yield __PRIVATE_setOnlineComponentProvider(e, t),
            r.resolve();
        } catch (e2) {
          const t2 = e2;
...
function clearIndexedDbPersistence(e) {
  ...
  const t = new __PRIVATE_Deferred();
  return (
    e._queue.enqueueAndForgetEvenWhileRestricted(() =>
      __async(this, null, function* () {
        try {
...
function waitForPendingWrites(e) {
  return (function __PRIVATE_firestoreClientWaitForPendingWrites(e2) {
    const t = new __PRIVATE_Deferred();
    return (
      e2.asyncQueue.enqueueAndForget(() =>
        __async(this, null, function* () {
          return __PRIVATE_syncEngineRegisterPendingWritesCallback(
            yield __PRIVATE_getSyncEngine(e2),
            t
          );
        })
      ),
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      n = this.Lu.map((e2) => __PRIVATE_parseData(e2, t)),
...
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericIncrementTransformOperation(
      e.serializer,
      toNumber(e.serializer, this.Bu)
    );
    return new FieldTransform(e.path, t);
  }
  isEqual(e) {
    return (
      e instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.Bu === e.Bu
    );
  }
};
...
function __PRIVATE_createError(e, t, n, r, i) {
  ...
  return (
    (s || o) &&
      ...
      o && (a += ` in document ${i}`),
      (a += ')')),
    new FirestoreError(v.INVALID_ARGUMENT, _ + e + a)
  );
}
...
function onSnapshot(e, ...t) {
  ...
  return (function __PRIVATE_firestoreClientListen(e2, t2, n2, r2) {
    ...
    return (
      e2.asyncQueue.enqueueAndForget(() =>
        __async(this, null, function* () {
          return __PRIVATE_eventManagerListen(
            yield __PRIVATE_getEventManager(e2),
            s2
          );
        })
      ),
      () => {
        i2.za(),
          e2.asyncQueue.enqueueAndForget(() =>
            __async(this, null, function* () {
              return __PRIVATE_eventManagerUnlisten(
                yield __PRIVATE_getEventManager(e2),
                s2
              );
            })
...
function executeWrite(e, t) {
  return (function __PRIVATE_firestoreClientWrite(e2, t2) {
    ...
    return (
      e2.asyncQueue.enqueueAndForget(() =>
        __async(this, null, function* () {
          return __PRIVATE_syncEngineWrite(
            yield __PRIVATE_getSyncEngine(e2),
            t2,
            n
          );
...
function getAggregateFromServer(e, t) {
  const n = __PRIVATE_cast(e.firestore, Firestore),
    ...
    i = __PRIVATE_mapToArray(
      t,
      (e2, t2) =>
        new __PRIVATE_AggregateImpl(t2, e2.aggregateType, e2._internalFieldPath)
    );
...
function setIndexConfiguration(e, t) {
  ...
  if (
    ...
    'memory' ===
      (null === (n = r._uninitializedComponentsProvider) || void 0 === n
        ? void 0
        : n._offlineKind)
  )
    return (
...
function getPersistentCacheIndexManager(e) {
  ...
  if (
    'persistent' !==
    (null === (t = r._uninitializedComponentsProvider) || void 0 === t
      ? void 0
      : t._offlineKind)
  )
    return null;
...
function deleteAllPersistentCacheIndexes(e) {
  ...
  __PRIVATE_firestoreClientDeleteAllFieldIndexes(e._client)
    .then((e2) =>
...
function _internalQueryToProtoQueryTarget(e) {
  ...
  return void 0 === n
    ? null
    : __PRIVATE_toQueryTarget(n, __PRIVATE_queryToTarget(e._query))._t;
}
...
var __PRIVATE_TestingHooksSpiImpl = class ___PRIVATE_TestingHooksSpiImpl {
  ...
  static get instance() {
    return (
      Me ||
        ((Me = new ___PRIVATE_TestingHooksSpiImpl()),
...
!(function __PRIVATE_registerFirestore(e, t = true) {
  !(function __PRIVATE_setSDKVersion(e2) {
    ...
    registerVersion(S, '4.7.1', e), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
...
@firebase/firestore/dist/index.esm2017.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=chunk-TKPIZR3G.js.map
