...
function _performApiRequest(_0, _1, _2, _3) {
  return __async(
    this,
    arguments,
    function* (auth, method, path, request, customErrorMap = {}) {
...
function _performSignInRequest(_0, _1, _2, _3) {
  return __async(
    ...
    arguments,
    function* (auth, method, path, request, customErrorMap = {}) {
      const serverResponse = yield _performApiRequest(
        auth,
        method,
        path,
        request,
...
function _reloadWithoutSaving(user3) {
  return __async(this, null, function* () {
    ...
    const response = yield _logoutIfInvalidated(
      user3,
      getAccountInfo(auth, {
        idToken: idToken3
      })
    ...
    const newIsAnonymous =
      !(user3.email && coreAccount.passwordHash) &&
...
function requestStsToken(auth, refreshToken) {
  return __async(this, null, function* () {
    const response = yield _performFetchWithErrorHandling(auth, {}, () =>
      __async(this, null, function* () {
...
var StsTokenManager = class _StsTokenManager {
  ...
  refresh(auth, oldToken) {
    return __async(this, null, function* () {
      const { accessToken, refreshToken, expiresIn } = yield requestStsToken(
        auth,
        oldToken
      );
      this.updateTokensAndExpiration(
...
var UserImpl = class _UserImpl {
  ...
  getIdToken(forceRefresh) {
    return __async(this, null, function* () {
      const accessToken = yield _logoutIfInvalidated(
        this,
  ...
  _assign(user3) {
    ...
    this.providerData = user3.providerData.map((userInfo) =>
  ...
  static _fromJSON(auth, object) {
    ...
    if (providerData && Array.isArray(providerData)) {
      user3.providerData = providerData.map((userInfo) =>
        Object.assign({}, userInfo)
      );
    }
    if (_redirectEventId) {
...
var PersistenceUserManager = class _PersistenceUserManager {
  ...
  static create(auth, persistenceHierarchy, userKey = 'authUser') {
    return __async(this, null, function* () {
      ...
      const availablePersistences = (yield Promise.all(
        persistenceHierarchy.map((persistence) =>
          __async(this, null, function* () {
...
var AuthImpl = class {
  ...
  _initializeWithPersistence(persistenceHierarchy, popupRedirectResolver) {
    ...
    this._initializationPromise = this.queue(() =>
      __async(this, null, function* () {
        ...
        this.persistenceManager = yield PersistenceUserManager.create(
          this,
        ...
        this.lastNotifiedUid =
          ((_b = this.currentUser) === null || _b === void 0
            ? void 0
            : _b.uid) || null;
        if (this._deleted) {
          return;
  ...
  initializeCurrentUserFromIdToken(idToken3) {
    return __async(this, null, function* () {
      try {
        ...
        const user3 = yield UserImpl._fromGetAccountInfoResponse(
          this,
          response,
          idToken3
        );
  ...
  initializeCurrentUser(popupRedirectResolver) {
    return __async(this, null, function* () {
      ...
      if (_isFirebaseServerApp(this.app)) {
        ...
        if (idToken3) {
          return new Promise((resolve) => {
            setTimeout(() =>
              this.initializeCurrentUserFromIdToken(idToken3).then(
                resolve,
                resolve
              )
            );
      ...
      const previouslyStoredUser =
        yield this.assertedPersistence.getCurrentUser();
  ...
  tryRedirectSignIn(redirectResolver) {
    return __async(this, null, function* () {
      let result = null;
      try {
        result = yield this._popupRedirectResolver._completeRedirectFn(
          this,
          redirectResolver,
          true
        );
  ...
  setPersistence(persistence) {
    ...
    return this.queue(() =>
      __async(this, null, function* () {
        yield this.assertedPersistence.setPersistence(
  ...
  _setRedirectUser(user3, popupRedirectResolver) {
    return __async(this, null, function* () {
      const redirectManager = yield this.getOrInitRedirectPersistenceManager(
        popupRedirectResolver
      );
      return user3 === null
        ? redirectManager.removeCurrentUser()
        : redirectManager.setCurrentUser(user3);
    });
  }
  ...
  _getAdditionalHeaders() {
    return __async(this, null, function* () {
      ...
      const heartbeatsHeader = yield (_a =
  ...
  _getAppCheckToken() {
    return __async(this, null, function* () {
      var _a;
      const appCheckTokenResult = yield (_a =
        this.appCheckServiceProvider.getImmediate({
          optional: true
        })) === null || _a === void 0
        ? void 0
        : _a.getToken();
            ...
            __async(this, null, function* () {
              getRecaptchaConfig(auth, {
                ...
                .then((response) => {
                  if (response.recaptchaKey === void 0) {
                    reject(
                      new Error('recaptcha Enterprise site key undefined')
                    );
                  } else {
...
function handleRecaptchaFlow(authInstance, request, actionName, actionMethod) {
  return __async(this, null, function* () {
    ...
    if (
      ...
      return actionMethod(authInstance, request).catch((error) =>
        __async(this, null, function* () {
...
function linkWithPhoneNumber$1(auth, request) {
  return __async(this, null, function* () {
    const response = yield _performSignInRequest(
      auth,
      'POST',
      '/v1/accounts:signInWithPhoneNumber',
      _addTidIfNecessary(auth, request)
...
var UserCredentialImpl = class _UserCredentialImpl {
  ...
  static _fromIdTokenResponse(
    ...
    return __async(this, null, function* () {
      const user3 = yield UserImpl._fromIdTokenResponse(
        auth,
        idTokenResponse,
        isAnonymous
      );
...
function signInAnonymously(auth) {
  return __async(this, null, function* () {
    ...
    const userCredential = yield UserCredentialImpl._fromIdTokenResponse(
      authInternal,
      'signIn',
      response,
      true
...
function _link$1(user3, credential, bypassAuthState = false) {
  return __async(this, null, function* () {
    const response = yield _logoutIfInvalidated(
      user3,
      credential._linkToIdToken(user3.auth, yield user3.getIdToken()),
      bypassAuthState
    );
...
function _signInWithCredential(auth, credential, bypassAuthState = false) {
  return __async(this, null, function* () {
    ...
    const response = yield _processCredentialSavingMfaContextIfNecessary(
      auth,
      operationType,
      credential
    );
...
function signInWithCustomToken(auth, customToken) {
  return __async(this, null, function* () {
    ...
    const cred = yield UserCredentialImpl._fromIdTokenResponse(
      authInternal,
      'signIn',
      response
    );
...
function fetchSignInMethodsForEmail(auth, email) {
  return __async(this, null, function* () {
    const continueUri = _isHttpOrHttps()
      ? _getCurrentUrl()
      : 'http://localhost';
    const request = {
      identifier: email,
    ...
    const { signinMethods } = yield createAuthUri(
      getModularInstance(auth),
      request
    );
...
function updateProfile(_0, _1) {
  return __async(
    this,
    arguments,
    function* (user3, { displayName, photoURL: photoUrl }) {
...
var MultiFactorResolverImpl = class _MultiFactorResolverImpl {
  ...
  static _fromError(authExtern, error) {
    ...
    return new _MultiFactorResolverImpl(session, hints, (assertion) =>
      __async(this, null, function* () {
        ...
        switch (error.operationType) {
          case 'signIn':
            const userCredential =
              yield UserCredentialImpl._fromIdTokenResponse(
                auth,
                error.operationType,
                idTokenResponse
              );
...
var MultiFactorUserImpl = class _MultiFactorUserImpl {
    ...
    user3._onReload((userInfo) => {
      if (userInfo.mfaInfo) {
        this.enrolledFactors = userInfo.mfaInfo.map((enrollment) =>
          MultiFactorInfoImpl._fromServerResponse(user3.auth, enrollment)
        );
      }
    });
  }
  ...
  enroll(assertionExtern, displayName) {
    return __async(this, null, function* () {
      ...
      const finalizeMfaResponse = yield _logoutIfInvalidated(
        this.user,
  ...
  unenroll(infoOrUid) {
    return __async(this, null, function* () {
      ...
      try {
        const idTokenResponse = yield _logoutIfInvalidated(
          this.user,
...
var BrowserLocalPersistence = class _BrowserLocalPersistence extends BrowserPersistenceClass {
  ...
  _set(key, value) {
    return __async(this, null, function* () {
      yield __superGet(_BrowserLocalPersistence.prototype, this, '_set').call(
        this,
        key,
        value
      );
  ...
  _get(key) {
    return __async(this, null, function* () {
      const value = yield __superGet(
        _BrowserLocalPersistence.prototype,
        this,
        '_get'
      ).call(this, key);
      this.localCache[key] = JSON.stringify(value);
...
var Receiver = class _Receiver {
  ...
  handleEvent(event) {
    return __async(this, null, function* () {
      ...
      if (
        !(handlers === null || handlers === void 0 ? void 0 : handlers.size)
      ) {
        return;
      }
...
var IndexedDBLocalPersistence = class {
  ...
  initializeReceiver() {
    return __async(this, null, function* () {
      ...
      this.receiver._subscribe('keyChanged', (_origin, data) =>
        __async(this, null, function* () {
      ...
      this.receiver._subscribe('ping', (_origin, _data) =>
        __async(this, null, function* () {
          return [
            'keyChanged'
...
var RecaptchaVerifier = class {
  ...
  init() {
    return __async(this, null, function* () {
      ...
      yield domReady();
      this.recaptcha = yield this._recaptchaLoader.load(
        this.auth,
...
function signInWithPhoneNumber(auth, phoneNumber, appVerifier) {
  return __async(this, null, function* () {
    ...
    const authInternal = _castAuth(auth);
    const verificationId = yield _verifyPhoneNumber(
      authInternal,
      phoneNumber,
...
var RedirectAction = class _RedirectAction extends AbstractPopupRedirectOperation {
  ...
  execute() {
    return __async(this, null, function* () {
      ...
      if (!readyOutcome) {
        try {
          const hasPendingRedirect = yield _getAndClearPendingRedirectStatus(
            this.resolver,
            this.auth
          );
          const result = hasPendingRedirect
            ? yield __superGet(_RedirectAction.prototype, this, 'execute').call(
                this
              )
            : null;
  ...
  onAuthEvent(event) {
    return __async(this, null, function* () {
      if (event.type === 'signInViaRedirect') {
        return __superGet(_RedirectAction.prototype, this, 'onAuthEvent').call(
          this,
          event
        );
...
var BrowserPopupRedirectResolver = class {
  ...
  _openPopup(auth, provider, authType, eventId) {
    return __async(this, null, function* () {
      ...
      const url = yield _getRedirectUrl(
        auth,
        provider,
        authType,
        _getCurrentUrl(),
...
var AuthInterop = class {
  ...
  addAuthTokenListener(listener) {
    ...
    const unsubscribe = this.auth.onIdTokenChanged((user3) => {
      listener(
        (user3 === null || user3 === void 0
          ? void 0
          : user3.stsTokenManager.accessToken) || null
      );
    });
...
var mintCookieFactory = (url) => (user3) =>
...
function user(auth) {
  return new Observable(function (subscriber) {
    var unsubscribe = onIdTokenChanged(
      auth,
      subscriber.next.bind(subscriber),
      subscriber.error.bind(subscriber),
      subscriber.complete.bind(subscriber)
...
var authInstance$ = timer(0, 300).pipe(
  concatMap(() => from(ɵgetAllInstancesOf(AUTH_PROVIDER_NAME))),
  distinct()
);
var PROVIDED_AUTH_INSTANCES = new InjectionToken('angularfire2.auth-instances');
function defaultAuthInstanceFactory(provided, defaultApp) {
  const defaultAuth = ɵgetDefaultInstanceOf(
    AUTH_PROVIDER_NAME,
    provided,
    defaultApp
  );
...
var createUserWithEmailAndPassword2 = ɵzoneWrap(
...
var reauthenticateWithCredential2 = ɵzoneWrap(
  reauthenticateWithCredential,
  true
);
var reauthenticateWithPhoneNumber2 = ɵzoneWrap(
...
rxfire/auth/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-C5PJ66XI.js.map
