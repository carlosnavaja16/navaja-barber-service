import { toSignal } from './chunk-2AYIIIOR.js';
import {
...
var FEATURE_STATE_PROVIDER = new InjectionToken(
...
var _ReducerManager = class _ReducerManager extends BehaviorSubject {
  ...
  addFeatures(features) {
    const reducers = features.reduce(
      (
        reducerDict,
        { reducers: reducers2, reducerFactory, metaReducers, initialState, key }
      ) => {
        const reducer =
...
_ScannedActionsSubject.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function ScannedActionsSubject_Factory(__ngFactoryType__) {
    return (
      ...
      (ɵScannedActionsSubject_BaseFactory = ɵɵgetInheritedFactory(
        _ScannedActionsSubject
      ))
...
_StoreFeatureModule.ɵfac = function StoreFeatureModule_Factory(
  __ngFactoryType__
) {
    ...
    for (const type of on2.types) {
      ...
      if (existingReducer) {
        const newReducer = (state, action) =>
          on2.reducer(existingReducer(state, action), action);
...
//# sourceMappingURL=chunk-2VKTTVTP.js.map
