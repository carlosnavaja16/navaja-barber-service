...
import { Platform, coerceBooleanProperty } from './chunk-C6GJ5ZWI.js';
...
import { Subject, Subscription, takeUntil } from './chunk-BO5GAICC.js';
...
function MatFormField_ng_template_0_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute(
      'for',
      ctx_r1._control.disableAutomaticLabeling ? null : ctx_r1._control.id
    );
    ɵɵadvance(2);
    ɵɵconditional(
...
_MatFormFieldLineRipple.ɵfac = function MatFormFieldLineRipple_Factory(
  __ngFactoryType__
) {
...
_MatFormFieldControl.ɵfac = function MatFormFieldControl_Factory(
  __ngFactoryType__
) {
  ...
  _initializeControl(previousControl) {
    ...
    if (previousControl) {
      this._elementRef.nativeElement.classList.remove(
        classPrefix + previousControl.controlType
      );
    }
    if (control.controlType) {
      this._elementRef.nativeElement.classList.add(
        classPrefix + control.controlType
      );
    }
    this._stateChanges?.unsubscribe();
...
_MatFormField.ɵcmp = ɵɵdefineComponent({
  ...
  template: function MatFormField_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(16, MatFormField_Case_16_Template, 2, 1, 'div', 16)(
        17,
...
_MatFormFieldModule.ɵfac = function MatFormFieldModule_Factory(
  __ngFactoryType__
) {
...
//# sourceMappingURL=chunk-I7ZPR7OC.js.map
